...
##
## Usage:  python3 mle.py <corpus.txt >model.dat
...
def readText() :
  global n,t1,t2,t3
  l1=sys.stdin.readline(); l1=l1.lower();
  while (l1!=""):
    l2=sys.stdin.readline(); l2=l2.lower();
...
for tg in t3 :
  ...
  if (x+y in t2) :
    ...
    count_bg = ???
    prob_tg = ???
    sys.stdout.write(tg+" "+str(prob_tg)+" "+str(count_tg)+" "+str(count_bg)+"\n")
